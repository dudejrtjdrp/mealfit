...
import { clearNearbyCache, mergeStores, placeToStore, searchNearbyStores, type KakaoPlace } from '../kakao';
...
describe('placeToStore', () => {
  ...
  it('모르는 매장은 coverage none, 좌표가 깨지면 null', () => {
    expect(placeToStore(place({ id: '2', place_name: '동네 김밥', category_group_code: 'FD6' }), YEOKSAM_CENTER)).toMatchObject({ brandId: undefined, coverage: 'none' });
