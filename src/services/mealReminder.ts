...
/** 알림 data.kind — 누르면 오늘 탭으로 */
export const REMINDER_KIND = 'meal-reminder';
export const REMINDER_ROUTE = '/(tabs)/today' as const;
...
export const REMINDER_COPY: Record<MealSlot, { title: string; body: string }> = {
  lunch: { title: '점심 뭐 드실지 고민되면', body: '근처에서 지금 먹기 좋은 메뉴를 골라뒀어요' },
  dinner: { title: '저녁 뭐 드실지 고민되면', body: '오늘 드신 걸 보고 지금 먹기 좋은 메뉴를 골라뒀어요' },
};
...
/** 알림을 눌렀을 때 갈 곳 — 우리 식사 알림이면 오늘 탭, 아니면 null */
